...
<tr>
    ...
    <td><h2>Tap #8</h2></td>
    <td>
        <?php echo "<img src='images/SRM ", $srm['Beer8'], ".png' height='55'></td>"; ?>
    <td>
        <?php echo "<h2>", $beername['Beer8'], "</h2>"; ?>
        <br/>
        <?php echo $style['Beer8']; ?>
        </td>
    <td><center>
        <?php echo $abv['Beer8'], " % ABV"; ?>
        <br/>
        <?php echo $ibu['Beer8'], " IBU"; ?>
        <br/><?php echo "<img src='images/", $hops['Beer8'], ".png' height='30'></center>"; ?>
        </td>
    <td></td>
...
<tr>
    ...
    <td>
        <?php echo "<img src='images/SRM ", $srm['Beer9'], ".png' height='55'></td>"; ?>
    <td>
        <?php echo "<h2>", $beername['Beer9'], "</h2>"; ?>
        <br/>
        <?php echo $style['Beer9']; ?>
        </td>
    <td><center>
        <?php echo $abv['Beer9'], " % ABV"; ?>
        <br/>
        <?php echo $ibu['Beer9'], " IBU"; ?>
        <br/><?php echo "<img src='images/", $hops['Beer9'], ".png' height='30'></center>"; ?>
        </td>
    <td></td>
    <td><h2>Tap #10</h2></td>
    <td>
        <?php echo "<img src='images/SRM ", $srm['Beer10'], ".png' height='55'></td>"; ?>
    <td>
        <?php echo "<h2>", $beername['Beer10'], "</h2>"; ?>
        <br/>
        <?php echo $style['Beer10']; ?>
        </td>
    <td><center>
        <?php echo $abv['Beer10'], " % ABV"; ?>
        <br/>
        <?php echo $ibu['Beer10'], " IBU"; ?>
        <br/><?php echo "<img src='images/", $hops['Beer10'], ".png' height='30'></center>"; ?>
        </td>
    <td></td>
...
<tr>
    ...
    <td>
        <?php echo "<img src='images/SRM ", $srm['Beer11'], ".png' height='55'></td>"; ?>
    <td>
        <?php echo "<h2>", $beername['Beer11'], "</h2>"; ?>
        <br/>
        <?php echo $style['Beer11']; ?>
        </td>
    <td><center>
        <?php echo $abv['Beer11'], " % ABV"; ?>
        <br/>
        <?php echo $ibu['Beer11'], " IBU"; ?>
        <br/><?php echo "<img src='images/", $hops['Beer11'], ".png' height='30'></center>"; ?>
        </td>
    <td></td>
    <td><h2>Tap #12</h2></td>
    <td>
        <?php echo "<img src='images/SRM ", $srm['Beer12'], ".png' height='55'></td>"; ?>
    <td>
        <?php echo "<h2>", $beername['Beer12'], "</h2>"; ?>
        <br/>
        <?php echo $style['Beer12']; ?>
        </td>
    <td><center>
        <?php echo $abv['Beer12'], " % ABV"; ?>
        <br/>
        <?php echo $ibu['Beer12'], " IBU"; ?>
        <br/><?php echo "<img src='images/", $hops['Beer12'], ".png' height='30'></center>"; ?>
        </td>
    <td></td>
